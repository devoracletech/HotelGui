...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->inventoryButton->Click += gcnew System::EventHandler(this, &AccountMenu::label1_Click);
			// 
			// reportsButton
			// 
			...
			this->logoutButton->Click += gcnew System::EventHandler(this, &AccountMenu::label6_Click);
			// 
			// createButton
			// 
